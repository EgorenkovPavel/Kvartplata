...
import com.epipasha.kvartplata.databinding.FragmentElecticityBinding;
...
public class ElectricityFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FragmentElecticityBinding binding = DataBindingUtil.inflate(
                inflater, R.layout.fragment_electicity, container, false);
